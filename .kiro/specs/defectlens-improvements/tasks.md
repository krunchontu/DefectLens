...
- [x] 1. Set up the API test harness
...
- [x] 2. Add baseline API tests against current behavior
...
- [x] 3. Persist prevention checklist progress (data + API)
...
- [x] 4. Wire persistent checklist into the defect detail UI
...
- [x] 5. Add defect list filtering, search, and pagination (API)
...
- [x] 6. Add filter/search controls and pagination to the defect list UI
...
- [x] 7. Add the audit trail model and recording helper
...
- [x] 8. Render the audit timeline on the defect detail page
  - Consume `GET /api/defects/:id/events` and render a reverse-chronological timeline
  - _Requirements: 5.4_

- [x] 9. Add trend metrics to the dashboard (API)
...
- [x] 10. Render trend charts on the dashboard UI
...
- [x] 11. Add the release-readiness (CAB pack) export (API)
...
- [x] 14. Harden the AI prompt against injection
...
- [x] 15. Add a global notification system to the UI
...
- [x] 16. Add presentation assets and headline metric
